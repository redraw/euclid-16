...
SEQ_STEP_TRIGGER_ON = 8
SEQ_STEP_TRIGGER_OFF = 9  # (channel, note, velocity)
SEQ_STEP_TRIGGER_CHANNELS = 10  # [ch1, ch2, ch3...] where chX is a value 0/1 if channel is triggered or not
SEQ_ACTIVE_STEP = 11
SEQ_TEMPO_CHANGE = 12
